...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline: 'border border-neutral bg-surface text-neutral hover:bg-neutral-light focus:ring-primary dark:bg-neutral-dark dark:text-white dark:border-neutral-light dark:hover:bg-neutral',
    ghost: 'text-neutral hover:bg-neutral-light focus:ring-primary dark:text-neutral-light dark:hover:bg-neutral',
